          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Página de Edição de Serviços</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
                ...
                <div class="card card-small mb-4 pt-3">
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item p-4">
                      <strong class="text-muted d-block mb-2">Mantenha o registro atualizado</strong>
                      <span class="text-muted d-block mb-2"><?php echo $telUp;?></span>
                      <span class="text-muted d-block mb-2"><?php echo $modUp;?></span>
                      <span class="text-muted d-block mb-2"><?php echo $fabUp;?></span>
                      <span class="text-muted d-block mb-2"><?php echo $seUp;?></span>
                      <span class="text-muted d-block mb-2"><?php echo $desUp;?></span>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="col-lg-8">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Verifique os dados</h6>
                  </div>
                  <ul class="list-group list-group-flush">
                        ...
                        <div class="col">
                          <form method="post" enctype="multipart/form-data">
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feFirstName">Nome do Cliente*</label>
                                <input type="text" name="nome" class="form-control" id="feFirstName" value="<?php echo $nomeUp?>"> 
                              </div>
                              <div class="form-group col-md-6">
                                <label for="feLastName">Modelo*</label>
                                <input type="text" name="modelo" class="form-control" id="feLastName" value="<?php echo $modUp?>"> 
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Fabricante*</label>
                                <input type="terxt" name="fab" class="form-control" id="feEmailAddress" value="<?php echo $fabUp?>"> </div>
                              <div class="form-group col-md-6">
                                <label for="fePassword">N° de Série*</label>
                                <input type="text" name="serie" class="form-control" id="fePassword" value="<?php echo $seUp?>"> 
                              </div>
                            </div>
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                <label for="feDescription">Descrição do Problema</label>
                          ...
                          <?php
                                    ...
                                    if(isset($_POST['btnUp'])){
                                        ...
                                        $editar="UPDATE tbstore SET clientStore=:nome,modStore=:modelo,fabStore=:fab,seStore=:serie,telStore=:tel,desStore=:descProblem WHERE idUser=:id";                   
                                        try {
