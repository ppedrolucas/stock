                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-0">Nome Completo</th>
                      ...
                      <?php
                            ...
                            $select = "SELECT * FROM tbusers ORDER BY idUser";
                            try{
                        ...
                        <tr>
                          ...
                          <td><?php echo $show->telUser;?></td>
                          <td><?php echo $show->emailUser;?></td>
                          <td><?php echo $show->passUser;?></td>
                          <td>
                            <a href="user-profile-lite.php?id=<?php echo $show->idUser;?>" class="btn btn-success">Up</a>
                            <a href="config/delete-user.php?idDel=<?php echo $show->idUser;?>" title="Remover" class="btn btn-danger">Dn</a>
                          </td>
                        </tr>
                        <?php
                          ...
                          echo '<div class="alert alert-danger" role="alert">
                                  <strong>OPS não há registros no momento, verifique sua tabela!</strong>
                                </div>';
                        }
